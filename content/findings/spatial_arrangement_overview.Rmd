...
```{r echo = FALSE, warning=FALSE, message=FALSE}
black_long_cors <- cooccur_spatial(S32N_long, spatial_words$space, n = 5, corr = 0.15) 
...
```{r echo = FALSE, warning=FALSE, message=FALSE}
white_long_cors <- cooccur_spatial(S32W_long, spatial_words$space, n = 5, corr = .15) 
...
```{r echo = FALSE, warning=FALSE, message=FALSE}
seg_short_cors <- cooccur_spatial(seg_short, spatial_words$space, n = 2, corr = .10) 
...
```{r echo = FALSE, warning=FALSE, message=FALSE}
int_short_cors <- cooccur_spatial(int_short, spatial_words$space, n = 0, corr = 0) 
