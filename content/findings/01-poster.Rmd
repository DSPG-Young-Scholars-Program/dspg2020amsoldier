...
The American Soldier project is a digital history project funded by the National Endowment of Humanities and is led by Professor Ed Gitre of Virginia Tech. The goal of the overall project is to take a range of surveys and commentaries by WW2 soldiers and a wide range of topics from race and gender relations, career plans, thoughts on South East Asia, and much more. Accompanied by Professor Gitre is Professor Mark Embree of Virginia Tech, who is using machine learning to unpack and understand the text data generated by the soldiers. 
...
* Survey 190
    ...
    + questions of interest
        - "Do women have rights?..." _replace with actual question_
...
The wordclouds below visualize words used uniquely by black and white soldiers, shown in orange and dark blue, respectively.
...
knitr::kable(gender_words %>% filter(category == "female" | category == "relation") %>% head())
```
...
When Black soldiers are talking about spatial arrangements, we see that there's a greater amount of commentary from black soldiers than white soldiers. Seating arrangements pop up in conversation with bigrams of "set seat", "front seat" as well as "cafe sit". Furthermore, spatial arrangements in which the Black soldiers talk about in regards to integration include camp, living, eating, px, service club, barrack and theater. All of these words are paired with words such as "mix", "together", "same", "separate", and "individual."
