...
* Survey 195 is more targeted to gender relations, but we don't have transcriptions for the free form text so we select responses that discuss gender from Survey 32 using a word dictionary. 
...
* Black men often were often falsely and publicly accused of sexual assault during this time period, and we can see that black soldiers are discussing that in their responses.
...
* White soliders are also discussing interracial marriage.
