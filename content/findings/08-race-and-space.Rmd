...
The size of the nodes in the bigrams are determined by in degree measure which is the number of edges or links being related to that node. 

<center>
![Black soldier long response bigrams](/findings/blk_long_bigram.svg){width=700px}
</center>
...
<center>
![White soldier long response bigrams](/findings/white_long_bigram.svg){width=700px}
</center>
