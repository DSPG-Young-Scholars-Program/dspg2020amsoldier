...
```{r topic, echo=FALSE, message=FALSE, warning=FALSE}
...
Latent Dirchlet Allocation, or LDA, is the typical go to method for topic modelling. 
The first network here displays `num_clusters` topics and this is  for the black soldiers response to the long comment
```{r black lda, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r 77 lda, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r 78 lda, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r btm, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r black btm, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r 77 btm, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r 78 btm, echo=FALSE, message=FALSE, warning=FALSE}
