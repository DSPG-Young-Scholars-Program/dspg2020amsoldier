...
A dictionary of gender words are loaded to identy which responses relate to gender topics. This dictionary was created with reference from "A Dictionary of Gender Studies" published by the Oxford University Press. In addition, there is consideration of how women were referred to in the 1940s such as "lady" and "sweetheart".
