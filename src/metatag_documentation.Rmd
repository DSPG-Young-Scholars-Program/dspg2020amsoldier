...
* brackets: Any entity of the transcription that is in brackets indicates a correction to its preceeding word in the soldier's response. Therefore, we plan to replace the preceeding word with the corrected word in the brackets. 
* unclear: The unclear tag is the most troublesome of all the metatags. There are many unique instances of its use, making it difficult to develop a consistent rule for treatment. However, any unclear tags with the absence of a word will be deleted, such as [unclear][/unclear] and [unclear]???[/unclear]. 