...
##### co-occurrances of the short response
```{r}
...
#plot
visualize_cooccur(seg_short_cors, "Pro Segregation Short Response - Spatial Arrangement Co-occurences")
```
...
#plot
visualize_cooccur(int_short_cors, "Pro Integration Short Response - Spatial Arrangement Co-occurences")
```



although these soldiers suported integration there seems to be a lot of talk about conditions on which the Black and White soldiers would share the same space. For example we see that both sleep and px were associated with separation. 

There is a burst/cluster surrounding the nodes Southern, Northern and live. When talking about possibly integrating outfits, the interactions of southerners and northerners were a significant topic. Soldiers seem to talk about the differencesi n culture between the southerners and northerners on regards to race relations. We also see that other ethnicities such as Chinese and Filipino are mentioned.
...
#plot
visualize_cooccur(seg_short_cors, "Pro Segregation Long Response - Spatial Arrangement Co-occurences")
```
...
#plot
visualize_cooccur(int_long_cors, "Pro Integration Long Response - Spatial Arrangement Co-occurences")
```
