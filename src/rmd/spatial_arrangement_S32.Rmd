...
The same co-occurance plot but with edited dictionary.

```{r}
seg_short_cors <- cooccur_spatial_edit(seg_short, n = 5, corr = 0.10) 
...
#subset data based on question and race
int_short_cors <- cooccur_spatial_edit(int_short, n = 0, corr = 0.01) 
...
When taking out words like north/south, the co-occurrence network is cleaner. however, changing the correlation threshold doesn't do anything for the short pro-integration responses.
