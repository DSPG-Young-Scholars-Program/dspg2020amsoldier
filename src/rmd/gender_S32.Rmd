...
```{r}
short_fem_co <- cooccur_gender(S32_short, female_words$gender, n=5, corr=.12)
...
visualize_cooccur(short_fem_co, "Female related co-occurrences for short soldier response")
```
