...
cooccur <- function(data, match, n=5, corr=.15){
  data %>%
...
# Compare the narrative of female to male commentary amongst all soldier responses 
```{r}
